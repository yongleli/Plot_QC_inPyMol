...
#dist NZ_HZ3, react_center & name hz3, react_center & name nz
dist Ow_O17, qwt & name o1, react_center & name o17
dist NZ_Ow, qwt & name o1, react_center & name nz
dist C_S,   react_center & name c22, react_center & name s1
hide labels
set dash_color, lime

unbond name h1, name o1
unbond name hz3, name nz
set_bond stick_radius, 0.1, name h1+o17
set_bond stick_radius, 0.1, name hz3+o1
set_bond stick_radius, 0.1, name h1+s1
